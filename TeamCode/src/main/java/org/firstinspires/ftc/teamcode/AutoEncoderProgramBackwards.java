...
@Autonomous(name = "AutoBackwards")
public class AutoEncoderProgramBackwards extends LinearOpMode {
        ...
        public void runOpMode() {
            ...
            moveBackwards(-100, 0.25);
        }

        // distance is in cm
        private void moveBackwards(double distance, double speed) {
